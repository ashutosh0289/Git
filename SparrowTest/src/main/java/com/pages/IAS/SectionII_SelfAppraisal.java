...
public class SectionII_SelfAppraisal extends TestBase{
	...
	@FindBy(xpath ="//textarea[@id='dutyDescription']")//textarea[@id='lF.selfAppraisal.dutyDescription']
	WebElement InputField_Sec2_DutyDescription_1;
	
	@FindBy(xpath ="//textarea[@id='lF.selfAppraisal.dutyDescription']")
	WebElement InputField_Sec2_DutyDescription;
	
	@FindBy(xpath ="//textarea[@id='exceptionalContribution']")//textarea[@id='lF.selfAppraisal.exceptionalContribution']
	WebElement InputField_Sec2_exceptionalContribution_1;
	
	@FindBy(xpath ="//textarea[@id='lF.selfAppraisal.exceptionalContribution']")
	WebElement InputField_Sec2_exceptionalContribution;
	
		
	@FindBy(xpath ="//textarea[@id='performanceHinderance']")//textarea[@id='lF.selfAppraisal.performanceHinderance']
	WebElement InputField_Sec2_performanceHinderance_1;
	
	@FindBy(xpath ="//textarea[@id='lF.selfAppraisal.performanceHinderance']")
	WebElement InputField_Sec2_performanceHinderance;
	
	@FindBy(xpath ="//textarea[@id='forCurrentAssignmentUpgradeSkill']")//textarea[@id='lF.selfAppraisal.forCurrentAssignmentUpgradeSkill']
	WebElement InputField_Sec2_CurrentAssignmentUpgradeSkill_1;
