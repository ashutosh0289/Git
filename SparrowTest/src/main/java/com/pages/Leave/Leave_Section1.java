...
public class Leave_Section1 extends TestBase {
				Util util;
	
	public Leave_Section1() {
...
@FindBy(xpath="//input[@id='studyCourseID_0']")
WebElement LeaveDetailCourse;
	
	
@FindBy(xpath="//input[@id='studyInstituteID_0']")
WebElement LeaveDetailInstitute;		
...
public void FillLeaveForm() throws IOException {
	...
	LeaveDetailCourse.sendKeys(data66);
	LeaveDetailInstitute.sendKeys(data66);
